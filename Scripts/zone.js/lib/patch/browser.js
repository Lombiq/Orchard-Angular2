System.register(['./functions', './promise', './mutation-observer', './define-property', './register-element', './event-target', './property-descriptor', './geolocation', './file-reader'], function(exports_1) {
