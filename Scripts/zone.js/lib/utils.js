System.register(['./keys'], function(exports_1) {
    var keys;
    var originalFnKey, boundFnsKey, originalInstanceKey;
    ...
    exports_1("isWebWorker", isWebWorker);
    ...
    exports_1("patchProperties", patchProperties);
    ...
    return {
        ...
        execute: function() {
            ...
            ;
            ;
            originalFnKey = keys.create('originalFn');
            boundFnsKey = keys.create('boundFns');
            ;
